...
![](./Figures/Pickups histogram pre borough(color)-1.png)<!-- -->
...
![](./Figures/Pickups histogram per borough(facet)-1.png)<!-- -->
...
![](./Figures/Weather histogram(facet)-1.png)<!-- -->

### Wind Speed


![](./Figures/Wind speed histogram-1.png)<!-- -->
...
![](./Figures/Visibility histogram-1.png)<!-- -->
...
![](./Figures/Temperature histogram-1.png)<!-- -->
...
![](./Figures/Dew point histogram-1.png)<!-- -->
...
![](./Figures/Precipitation histogram(grid)-1.png)<!-- -->
...
![](./Figures/Snow depth histogram-1.png)<!-- -->
...
![](./Figures/Pickups VS datetime-1.png)<!-- -->
...
![](./Figures/Pickups VS workday-1.png)<!-- -->
![](./Figures/Brooklyn pickups VS workday-1.png)<!-- -->
...
![](./Figures/Pickups VS temperature-1.png)<!-- -->
...
![](./Figures/Temperature VS datetime-1.png)<!-- -->
...
![](./Figures/pickups VS visibility-1.png)<!-- -->

### Pickups VS sea level pressure

![](./Figures/Pickups VS SLP-1.png)<!-- -->

### Pickups VS precipitation

![](./Figures/Pickups VS precipitations(01)-1.png)<!-- -->
...
![](./Figures/Pickups VS snow depth-1.png)<!-- -->
...
![](./Figures/Borough and time of the day-1.png)<!-- -->

![](./Figures/Borough and time of the day(log)-1.png)<!-- -->
...
![](./Figures/Day and time of the day-1.png)<!-- -->
...
![](./Figures/Working VS non-working days-1.png)<!-- -->

![](./Figures/Working VS non-working days per major borough-1.png)<!-- -->
![](./Figures/Working VS non-working days(boxplot)-1.png)<!-- -->
...
![](./Figures/Temperature and rain(temperature)-1.png)<!-- -->
![](./Figures/Temperature and rain(rain)-1.png)<!-- -->
...
![](./Figures/Plotting models-1.png)<!-- -->

![](./Figures/Plotting models per day-1.png)<!-- -->
...
![](./Figures/Plotting Saturday June 27-1.png)<!-- -->
