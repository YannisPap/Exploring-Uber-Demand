...
![](./figures/Pickups_histogram_per_borough(color)-1.png)<!-- -->
...
![](./figures/Pickups_histogram_per_borough(facet)-1.png)<!-- -->
...
![](./figures/Weather_histogram(facet)-1.png)<!-- -->

### Wind Speed

![](./figures/Wind_speed_histogram-1.png)<!-- -->
...
![](./figures/Visibility_histogram-1.png)<!-- -->
...
![](./figures/Temperature_histogram-1.png)<!-- -->
...
![](./figures/Dew_point_histogram-1.png)<!-- -->
...
![](./figures/Precipitation_histogram(grid)-1.png)<!-- -->
...
![](./figures/Precipitation_histogram(log)-1.png)<!-- -->

### Snow Depth

Snow depth may also affect ridership.

![](./figures/Snow_depth_histogram-1.png)<!-- -->
...
![](./figures/Pickups_VS_datetime-1.png)<!-- -->
...
![](./figures/Pickups_VS_workday-1.png)<!-- --> ![](./figures/Brooklyn_pickups_VS_workday-1.png)<!-- -->
...
![](./figures/Pickups_VS_temperature-1.png)<!-- -->
...
![](./figures/over_75_boxplot-1.png)<!-- -->

Now the correlation is more obvious.

### Temperature VS datetime

![](./figures/Temperature_VS_datetime-1.png)<!-- -->
...
![](./figures/pickups_VS_visibility-1.png)<!-- -->

### Pickups VS sea level pressure

![](./figures/Pickups_VS_SLP-1.png)<!-- -->

### Pickups VS precipitation

![](./figures/Pickups_VS_precipitations(01)-1.png)<!-- -->
...
![](./figures/Pickups_VS_snow_depth-1.png)<!-- -->
...
![](./figures/Borough_and_time_of_the_day-1.png)<!-- -->

![](./figures/Borough_and_time_of_the_day(log)-1.png)<!-- -->
...
![](./figures/Day_and_time_of_the_day-1.png)<!-- -->
...
![](./figures/Working_VS_non-working_days-1.png)<!-- -->

![](./figures/Working_VS_non-working_days_per_major_borough-1.png)<!-- --> ![](./figures/Working_VS_non-working_days(boxplot)-1.png)<!-- -->
...
![](./figures/Temperature_and_rain(temperature)-1.png)<!-- --> ![](./figures/Temperature_and_rain(rain)-1.png)<!-- -->
...
![](./figures/Plotting_models-1.png)<!-- -->

![](./figures/Plotting_models_per_day-1.png)<!-- -->
...
![](./figures/Plotting_Saturday_June_27-1.png)<!-- -->
