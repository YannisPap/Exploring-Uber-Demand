...
![](./figures/Pickups_VS_workday-1.png)<!-- -->
![](./figures/Brooklyn_pickups_VS_workday-1.png)<!-- -->
...
![](./figures/Working_VS_non-working_days_per_major_borough-1.png)<!-- -->
![](./figures/Working_VS_non-working_days(boxplot)-1.png)<!-- -->
...
![](./figures/Temperature_and_rain(temperature)-1.png)<!-- -->
![](./figures/Temperature_and_rain(rain)-1.png)<!-- -->
